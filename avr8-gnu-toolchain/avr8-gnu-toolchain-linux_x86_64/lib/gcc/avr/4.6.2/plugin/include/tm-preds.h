/* Generated automatically by the program 'build/genpreds'
   from the machine description file '/home/tools/hudson/workspace/avr8-gnu-toolchain/src/gcc/gcc/config/avr/avr.md'.  */
...
extern int a_register_operand (rtx, enum machine_mode);
