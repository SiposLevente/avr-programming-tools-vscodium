...
#endif
#ifdef GENERATOR_FILE
extern int avr_list_supported_parts;
#else
  int x_avr_list_supported_parts;
#define avr_list_supported_parts global_options.x_avr_list_supported_parts
#endif
#ifdef GENERATOR_FILE
extern const char *avr_mcu_name;
#else
  const char *x_avr_mcu_name;
#define avr_mcu_name global_options.x_avr_mcu_name
#endif
#ifdef GENERATOR_FILE
...
enum opt_code
{
  ...
  OPT_mcall_prologues = 941,                 /* -mcall-prologues */
  OPT_mdeb = 942,                            /* -mdeb */
  OPT_mint8 = 943,                           /* -mint8 */
  OPT_mlist_devices = 944,                   /* -mlist-devices */
  OPT_mmcu_ = 945,                           /* -mmcu= */
  OPT_mno_interrupts = 946,                  /* -mno-interrupts */
  OPT_morder1 = 947,                         /* -morder1 */
  OPT_morder2 = 948,                         /* -morder2 */
  OPT_mpmem_wrap_around = 949,               /* -mpmem-wrap-around */
  OPT_mrelax = 950,                          /* -mrelax */
  OPT_mshort_calls = 951,                    /* -mshort-calls */
  OPT_mtiny_stack = 952,                     /* -mtiny-stack */
  OPT_n = 953,                               /* -n */
  OPT_no_canonical_prefixes = 954,           /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 955,               /* -no-integrated-cpp */
  OPT_nocpp = 956,                           /* -nocpp */
  OPT_nodefaultlibs = 957,                   /* -nodefaultlibs */
  OPT_nostartfiles = 958,                    /* -nostartfiles */
  OPT_nostdinc = 959,                        /* -nostdinc */
  OPT_nostdinc__ = 960,                      /* -nostdinc++ */
  OPT_nostdlib = 961,                        /* -nostdlib */
  OPT_o = 962,                               /* -o */
  OPT_p = 963,                               /* -p */
  OPT_pass_exit_codes = 964,                 /* -pass-exit-codes */
  OPT_pedantic = 965,                        /* -pedantic */
  OPT_pedantic_errors = 966,                 /* -pedantic-errors */
  OPT_pg = 967,                              /* -pg */
  OPT_pie = 968,                             /* -pie */
  OPT_pipe = 969,                            /* -pipe */
  OPT_print_file_name_ = 970,                /* -print-file-name= */
  OPT_print_libgcc_file_name = 971,          /* -print-libgcc-file-name */
  OPT_print_multi_directory = 972,           /* -print-multi-directory */
  OPT_print_multi_lib = 973,                 /* -print-multi-lib */
  OPT_print_multi_os_directory = 974,        /* -print-multi-os-directory */
  OPT_print_objc_runtime_info = 975,         /* -print-objc-runtime-info */
  OPT_print_prog_name_ = 976,                /* -print-prog-name= */
  OPT_print_search_dirs = 977,               /* -print-search-dirs */
  OPT_print_sysroot = 978,                   /* -print-sysroot */
  OPT_print_sysroot_headers_suffix = 979,    /* -print-sysroot-headers-suffix */
  OPT_quiet = 980,                           /* -quiet */
  OPT_r = 981,                               /* -r */
  OPT_remap = 982,                           /* -remap */
  OPT_s = 983,                               /* -s */
  OPT_s_bc_abi = 984,                        /* -s-bc-abi */
  OPT_save_temps = 985,                      /* -save-temps */
  OPT_save_temps_ = 986,                     /* -save-temps= */
  OPT_shared = 987,                          /* -shared */
  OPT_shared_libgcc = 988,                   /* -shared-libgcc */
  /* OPT_specs = 989, */                     /* -specs */
  OPT_specs_ = 990,                          /* -specs= */
  OPT_static = 991,                          /* -static */
  OPT_static_libgcc = 992,                   /* -static-libgcc */
  OPT_static_libgcj = 993,                   /* -static-libgcj */
  OPT_static_libgfortran = 994,              /* -static-libgfortran */
  OPT_static_libgo = 995,                    /* -static-libgo */
  OPT_static_libstdc__ = 996,                /* -static-libstdc++ */
  /* OPT_std_c__03 = 997, */                 /* -std=c++03 */
  OPT_std_c__0x = 998,                       /* -std=c++0x */
  OPT_std_c__98 = 999,                       /* -std=c++98 */
  OPT_std_c1x = 1000,                        /* -std=c1x */
  /* OPT_std_c89 = 1001, */                  /* -std=c89 */
  OPT_std_c90 = 1002,                        /* -std=c90 */
  OPT_std_c99 = 1003,                        /* -std=c99 */
  /* OPT_std_c9x = 1004, */                  /* -std=c9x */
  OPT_std_f2003 = 1005,                      /* -std=f2003 */
  OPT_std_f2008 = 1006,                      /* -std=f2008 */
  OPT_std_f95 = 1007,                        /* -std=f95 */
  OPT_std_gnu = 1008,                        /* -std=gnu */
  OPT_std_gnu__0x = 1009,                    /* -std=gnu++0x */
  OPT_std_gnu__98 = 1010,                    /* -std=gnu++98 */
  OPT_std_gnu1x = 1011,                      /* -std=gnu1x */
  /* OPT_std_gnu89 = 1012, */                /* -std=gnu89 */
  OPT_std_gnu90 = 1013,                      /* -std=gnu90 */
  OPT_std_gnu99 = 1014,                      /* -std=gnu99 */
  /* OPT_std_gnu9x = 1015, */                /* -std=gnu9x */
  /* OPT_std_iso9899_1990 = 1016, */         /* -std=iso9899:1990 */
  OPT_std_iso9899_199409 = 1017,             /* -std=iso9899:199409 */
  /* OPT_std_iso9899_1999 = 1018, */         /* -std=iso9899:1999 */
  /* OPT_std_iso9899_199x = 1019, */         /* -std=iso9899:199x */
  OPT_std_legacy = 1020,                     /* -std=legacy */
  OPT_symbolic = 1021,                       /* -symbolic */
  OPT_t = 1022,                              /* -t */
  OPT_time = 1023,                           /* -time */
  OPT_time_ = 1024,                          /* -time= */
  OPT_traditional = 1025,                    /* -traditional */
  OPT_traditional_cpp = 1026,                /* -traditional-cpp */
  OPT_trigraphs = 1027,                      /* -trigraphs */
  OPT_u = 1028,                              /* -u */
  OPT_undef = 1029,                          /* -undef */
  OPT_v = 1030,                              /* -v */
  OPT_version = 1031,                        /* -version */
  OPT_w = 1032,                              /* -w */
  OPT_wrapper = 1033,                        /* -wrapper */
  OPT_x = 1034,                              /* -x */
  OPT_z = 1035,                              /* -z */
  N_OPTS,
  OPT_SPECIAL_unknown,
